...
{
    public class EnviaDadosEbook
    {
        #region enviaEmailDadosEbook
        public string enviaEmailDadosEbook(string destinatario, DadosEbook dados)
        {
            string retorno = "";
            try
            {
                ...
                objEmail.Body = "<html><body>Um novo download de Ebook foi efetuado<br><br> " +
                "<b>nome: " + dados.Nome + "<br>" +
